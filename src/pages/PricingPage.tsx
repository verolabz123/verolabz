          ...
          <DialogHeader>
            ...
            <DialogDescription>
              <div className="mt-4 p-4 rounded-lg bg-[hsl(var(--muted))]">
                <p className="text-sm">
                  In this demo, billing is mocked. In the production version,
                  this would connect to Stripe or Razorpay for secure payment
                  processing.
                </p>
                <p className="text-sm mt-2 text-[hsl(var(--muted-foreground))]">
                  To continue with this plan, please register for an account
                  first.
                </p>
              </div>

...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-[hsl(var(--border))] bg-transparent px-3 text-sm font-medium transition-colors hover:bg-[hsl(var(--secondary))] focus:outline-none focus:ring-1 focus:ring-[hsl(var(--ring))] disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-[hsl(var(--muted))]/40 group-[.destructive]:hover:border-[hsl(var(--destructive))]/30 group-[.destructive]:hover:bg-[hsl(var(--destructive))] group-[.destructive]:hover:text-[hsl(var(--destructive-foreground))] group-[.destructive]:focus:ring-[hsl(var(--destructive))]",
      className,
    )}
    {...props}
  />

...
const steps = [
    {
        ...
        description: "Drag and drop resumes in any format (PDF, DOCX, TXT). Upload one at a time or in bulk.",
        details: [
    ...
    },
    {
        ...
        description: "Our system extracts key information from each resume automatically.",
        details: [
    ...
    },
    {
        icon: Brain,
        title: "3. AI Scoring",
        description: "Each candidate receives an ATS score based on resume quality and completeness.",
        details: [
    ...
    },
    {
        ...
        description: "AI compares candidates against your job requirements for best-fit recommendations.",
        details: [
            "Skills gap analysis",
    ...
    },
    {
        ...
        description: "Get notified when high-match candidates are found or when action is needed.",
        details: [
            "Email notifications",
            "In-app alerts",
    ...
    },
    {
        ...
        description: "Review AI recommendations and shortlist the best candidates with one click.",
        details: [
    ...
    },
    {
        ...
        description: "All changes sync in real-time to your dashboard with updated analytics.",
        details: [
    ...
    },
    {
        ...
        description: "Send automated emails to candidates based on their status changes.",
        details: [
                                        ...
                                        <CardContent>
                                            <div className="ml-[4.5rem] grid sm:grid-cols-2 gap-2">
                                                {step.details.map((detail, j) => (
                                                    <div key={j} className="flex items-center gap-2 text-sm text-[hsl(var(--muted-foreground))]">
                        ...
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <div className="grid md:grid-cols-3 gap-6 mb-12">
                                {[
                                    ...
                                    { step: "2", title: "Upload Resume", desc: "Drop a resume to test parsing" },
                                    { step: "3", title: "See Results", desc: "View extracted data instantly" },
                                ].map((item, i) => (
